...
class HomeScreen extends StatefulWidget {
  ...
  const HomeScreen(this.url, {Key? key, this.mainPage = true}) : super(key: key);
...
class _HomeScreenState extends State<HomeScreen> with AutomaticKeepAliveClientMixin<HomeScreen>, TickerProviderStateMixin {
  ...
  late AnimationController navigationContainerAnimationController = AnimationController(vsync: this, duration: const Duration(milliseconds: 500));
  ...
  void initState() {
    ...
    if (!showBottomNavigationBar) {
      Future.delayed(Duration.zero, () {
        context.read<NavigationBarProvider>().setAnimationController(navigationContainerAnimationController);
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton: !showBottomNavigationBar && showFloatingActionButton
            ? FadeTransition(
